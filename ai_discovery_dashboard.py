...
def main():
    ...
    # Create main tabs for organization-wide vs function-specific analysis
    main_tabs = st.tabs(["🌐 Organization-Wide Analysis", "🏢 Function-Specific Analysis"])
    ...
    # Function-Specific Analysis Tab
    with main_tabs[1]:
        st.header("🏢 Function-Specific Deep Dive")
